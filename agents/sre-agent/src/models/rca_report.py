...
class AlertContext(BaseModel):
    """
    Simplified alert information.
    No optional fields because OpenRouter structured output
    has problems with anyOf.
    """
...
class Evidence(BaseModel):
    ...
    type: str = Field(
        description="Evidence type: log, metric or trace"
    )
